...
import random
import math
import pygame # Python game engine
...
def flip(sprites):
    return [pygame.transform.flip(sprite, True, False) for sprite in sprites] # takes a list of images
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, width, height):
        ...
        self.hit = False    # For fire touched
        self.hit_count = 0
...
def main(window):
    ...
    fire.on()
    fire1 = Fire(750, HEIGHT - block_size - 64, 16, 32)
    fire1.on()
    fire2 = Fire(1500, HEIGHT - block_size - 64, 16, 32)
    fire2.on()
